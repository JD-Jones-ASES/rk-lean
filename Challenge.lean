...
def pool4 : List (ℕ × List (ℕ × ℕ) × ℕ) :=
  [(5, [(0, 3), (1, 2), (2, 1), (3, 0)], 4),
   ...
   (29, [(0, 7), (1, 6), (2, 5), (3, 2), (5, 9), (6, 8), (14, 10), (15, 9), (16, 3), (17, 0), (25,
     4), (26, 1)], 11),
   ...
   (53, [(0, 0), (3, 0), (5, 5), (6, 1), (8, 2), (11, 6), (14, 6), (17, 7), (29, 1), (32, 1), (35,
     2), (37, 3), (38, 2), (40, 7), (41, 4), (43, 7)], 8),
...
def pool6 : List (ℕ × List (ℕ × ℕ) × ℕ) :=
  [(7, [(0, 5), (1, 4), (2, 3), (3, 2), (4, 1), (5, 0)], 6),
   ...
   (67, [(0, 9), (1, 5), (2, 3), (4, 6), (8, 12), (10, 4), (14, 1), (17, 2), (20, 3), (26, 0), (30,
     10), (33, 11), (37, 13), (39, 0), (43, 11), (46, 12), (47, 8), (49, 13), (55, 9), (56, 7),
     (58, 10), (59, 8), (65, 4)], 14),
   ...
   (127, [(0, 4), (1, 1), (4, 0), (7, 5), (13, 2), (16, 1), (22, 1), (27, 7), (28, 2), (31, 1),
     ...
     (79, 3), (84, 6), (85, 2), (86, 0), (92, 0), (97, 8), (99, 4), (101, 0), (106, 7), (112,
     6), (113, 1), (114, 0), (119, 5)], 9),
   (139, [(0, 16), (1, 11), (5, 19), (11, 12), (20, 1), (25, 14), (30, 2), (31, 0), (40, 12), (41,
     5), (43, 2), (45, 7), (46, 6), (48, 17), (50, 16), (55, 8), (57, 4), (60, 17), (62, 18),
     (69, 9), (71, 18), (73, 21), (78, 9), (90, 5), (91, 3), (97, 0), (113, 6), (115, 14), (116,
     13), (117, 10), (118, 4), (128, 16), (129, 15), (138, 20)], 22)]
